...
import com.iddera.userprofile.api.domain.location.service.concretes.DefaultStateService;
...
public class StateServiceTest {
    ...
    void setUp() {
        ...
        stateService = new DefaultStateService(stateRepository, countryRepository, exception);
    }
